      ...
      try {
        ...
        const enhancedData = await Promise.all(
          rawData.map(async (video) => {
            ...
            const tmdb = await searchMovieByTitle(
            ...
            return {
              ...
              tmdb,
              enhancedTitle:
                tmdb?.title || video.title || video.filename || "Unknown Movie",
              enhancedDescription:
                tmdb?.description || video.file_descr || "",
              enhancedPoster:
                tmdb?.poster || video.thumbnail || video.screenshot || null,
              enhancedBackdrop:
                tmdb?.backdrop || video.thumbnail || video.screenshot || null,
              enhancedRating: tmdb?.rating || 0,
              enhancedReleaseDate: tmdb?.releaseDate || "",
            };
          })
        );
