...
const MovieCard = ({
  ...
  const poster =
    video.enhancedPoster ||
    video.thumbnail ||
    video.screenshot ||
    'https://images.unsplash.com/photo-1489599856026-e27b5e10d4b4?w=500&h=750&fit=crop';
  ...
  return (
    <Link
      href={`/video/${video.file_code || video.filecode}`}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          <div className="flex items-center justify-between text-gray-300 text-sm">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span>
                {video.enhancedRating
                  ? video.enhancedRating.toFixed(1)
                  : 'N/A'}
              </span>
            </div>
...
const Hero = ({ videos }) => {
  ...
  const currentVideo =
    displayedVideos[currentMovieIndex];
  ...
  const backdrop =
    currentVideo.enhancedBackdrop ||
    currentVideo.enhancedPoster ||
    currentVideo.thumbnail ||
    'https://images.unsplash.com/photo-1489599856026-e27b5e10d4b4?w=1920&h=1080&fit=crop';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex items-center space-x-6 mb-6 text-gray-300">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-lg font-semibold">
                  {currentVideo.enhancedRating
                    ? currentVideo.enhancedRating.toFixed(1)
                    : 'N/A'}
                </span>
            ...
            {currentVideo.enhancedDescription && (
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl line-clamp-3">
                {currentVideo.enhancedDescription}
              </p>
            )}
            ...
            <div className="flex space-x-4">
              ...
              <Link
                href={`/video/${currentVideo.file_code || currentVideo.filecode}`}
                className="flex items-center space-x-2 bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors"
              >
              ...
              <button
                className="flex items-center space-x-2 bg-gray-800/80 hover:bg-gray-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors"
              >
...
const Home = () => {
  ...
  const [enhancingVideos, setEnhancingVideos] =
    useState(false);
  ...
  useEffect(() => {
    ...
    const fetchAndEnhanceVideos = async () => {
      ...
      try {
        ...
        console.log(
          '1. Fetching videos from Next API...'
        );
        ...
        console.log(
          '2. VIDEOS FROM NEXT API:',
          data
        );

        if (!data.length) {
          console.log(
            'No videos returned from API'
          );
        ...
        console.log(
          '3. Sending videos to TMDB...'
        );

        const enhancedData =
          await enhanceVideosWithTMDB(data);
        ...
        setError(
          'Check your internet or the server is down'
        );
